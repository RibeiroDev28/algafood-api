...
insert into restaurante (id, nome, taxa_frete, cozinha_id, DATA_CADASTRO, DATA_ATUALIZACAO) values (4, 'BacanaPub', '0.0', '1', utc_timestamp, utc_timestamp);
insert into restaurante (id, nome, TAXA_FRETE, COZINHA_ID, DATA_CADASTRO, DATA_ATUALIZACAO) values (5, 'RibeiroBar`s', '5.5', '3', utc_timestamp, utc_timestamp);
