...
insert into cidade (id, nome, estado_id) values (6, 'Içara', '4');
insert into cidade (id, nome, estado_id) values (7, 'Urubici', '4');
insert into cidade (id, nome, estado_id) values (8, 'Ponta Grossa', '5');
...
insert into restaurante (id, nome, taxa_frete, cozinha_id, DATA_CADASTRO, DATA_ATUALIZACAO,ativo, aberto) values (4, 'BacanaPub', '0.0', '1', utc_timestamp, utc_timestamp, true, true);
insert into restaurante (id, nome, TAXA_FRETE, COZINHA_ID, DATA_CADASTRO, DATA_ATUALIZACAO,ativo, aberto) values (5, 'RibeiroBar`s', '5.5', '3', utc_timestamp, utc_timestamp, true, true);
...
insert into restaurante_forma_pagamento (restaurante_id, forma_pagamento_id) values (1, 1), (1, 2), (1, 3), (2, 3), (3, 2), (3, 3), (4, 3), (5, 1), (5, 2), (5, 3);
...
insert into produto (nome, descricao, preco, ativo, restaurante_id) values ('Camarão tailandês', '16 camarões grandes ao molho picante', 110, 1, 5);
...
insert into usuario (id, nome, email, senha, data_cadastro) values (5, 'Débora Mendonça', 'email.teste.aw+debora@gmail.com', '123', utc_timestamp);
insert into usuario (id, nome, email, senha, data_cadastro) values (6, 'Matheus Ribeiro', 'matheus.ribeiro6611@gmail.com', '123', utc_timestamp);

insert into usuario_grupo (usuario_id, grupo_id) values (1, 1), (1, 2), (2, 2);

insert into restaurante_usuario_responsavel (restaurante_id, usuario_id) values (1, 5), (3, 5);

insert into pedido (id, codigo, restaurante_id, usuario_cliente_id, forma_pagamento_id, endereco_cidade_id, endereco_cep, endereco_logradouro, endereco_numero, endereco_complemento, endereco_bairro, status, data_criacao, subtotal, taxa_frete, valor_total) values (1, 'f9981ca4-5a5e-4da3-af04-933861df3e55', 1, 6, 1, 1, '38400-000', 'Rua Floriano Peixoto', '500', 'Apto 801', 'Brasil', 'CRIADO', utc_timestamp, 298.90, 10, 308.90);
...
insert into pedido (id, codigo, restaurante_id, usuario_cliente_id, forma_pagamento_id, endereco_cidade_id, endereco_cep, endereco_logradouro, endereco_numero, endereco_complemento, endereco_bairro, status, data_criacao, subtotal, taxa_frete, valor_total) values (2, 'd178b637-a785-4768-a3cb-aa1ce5a8cdab', 4, 1, 2, 1, '38400-111', 'Rua Acre', '300', 'Casa 2', 'Centro','CRIADO', utc_timestamp, 79, 0, 79);
